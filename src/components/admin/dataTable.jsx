...
export function DataTable({ columns, data, searchKey = "name", onAdd, addLabel = "Add Item" }) {
  ...
  return {
    ...
    cell: ({ row }) => {
      ...
      return (
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="h-8 w-8 p-0 focus-visible:!outline-none focus-visible:ring-0">
