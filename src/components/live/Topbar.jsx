...
if (!isReady) return null;
  ...
  return (
    <div className="sticky top-0 z-40 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-1 px-3 py-2 flex-wrap  ">
        {/* 🧭 Left side: Controls */}
        ...
        {/* 🧮 Scoreboard */}
        <div className="flex items-center gap-2 flex-wrap justify-content-center">
